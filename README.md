...
`Explanation_Text` is generated as concise, human-readable rationale using top feature contributors and final risk score.
`Risk_Score` represents the model's predicted probability of loan approval (sigmoid output of fusion logit).
